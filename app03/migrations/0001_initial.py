# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-02-16 20:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instruction', models.CharField(blank=True, max_length=256, null=True, verbose_name='说明')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_instruction', models.TextField(blank=True, null=True, verbose_name='本节课程内容概要')),
                ('has_homework', models.BooleanField(default=True, verbose_name='本节有作业')),
                ('homework_title', models.CharField(blank=True, max_length=64, null=True, verbose_name='本节作业标题')),
                ('homework_instruction', models.TextField(blank=True, max_length=500, null=True, verbose_name='作业描述')),
                ('exam', models.TextField(blank=True, max_length=300, null=True, verbose_name='踩分点')),
                ('class_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.ClassList', verbose_name='班级')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '已报名'), (2, '未报名')], default=2, help_text='选择客户此时的状态', verbose_name='报名状态')),
                ('date', models.DateField(auto_now_add=True, verbose_name='咨询日期')),
                ('recv_date', models.DateField(blank=True, null=True, verbose_name='顾问接单日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dist_date', models.DateField(auto_now_add=True, verbose_name='分配日期')),
                ('status', models.IntegerField(choices=[(1, '正在跟进'), (2, '已成单'), (3, '15天未成单'), (4, '3天未跟进')], default=1, verbose_name='状态')),
                ('memo', models.CharField(blank=True, max_length=100, null=True, verbose_name='更多信息')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app03.ClassList', verbose_name='班级')),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instruction', models.CharField(blank=True, max_length=256, null=True, verbose_name='备注')),
                ('class_list', models.ManyToManyField(blank=True, to='app03.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app03.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('record', models.CharField(choices=[('checked', '已签到'), ('vacate', '请假'), ('late', '迟到'), ('absence', '缺勤'), ('leave_early', '早退')], default='checked', max_length=64, verbose_name='上课记录')),
                ...
                ('stu_instruction', models.TextField(blank=True, null=True, verbose_name='学员备注')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.Student', verbose_name='学员')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ...
                ('wechat_id', models.CharField(blank=True, max_length=32, null=True, verbose_name='微信ID')),
                ('auth_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rbac.User', verbose_name='关联账户')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.Department', to_field='code', verbose_name='部门')),
            ],
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='consultant',
            field=models.ForeignKey(help_text='谁签的单就选谁', on_delete=django.db.models.deletion.CASCADE, to='app03.UserInfo', verbose_name='负责老师'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='customer',
        ...
        migrations.AddField(
            ...
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.UserInfo', verbose_name='顾问'),
        ),
        migrations.AddField(
            model_name='customerdistribution',
            name='customer',
        ...
        migrations.AddField(
            model_name='customer',
            name='course',
            field=models.ManyToManyField(to='app03.Course', verbose_name='咨询课程'),
        ),
        migrations.AddField(
            model_name='customer',
            name='referral_from',
        ...
        migrations.AddField(
            ...
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.UserInfo', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.UserInfo', verbose_name='跟踪人'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.Course', verbose_name='课程名称'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='headmaster',
        ...
        migrations.AddField(
            model_name='classlist',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app03.School', verbose_name='校区'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(related_name='teach_classes', to='app03.UserInfo', verbose_name='任课老师'),
        ),
    ]
